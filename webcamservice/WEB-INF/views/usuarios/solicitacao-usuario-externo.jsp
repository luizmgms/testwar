    ...
    <nav class="navbar navbar-default navbar-fixed-top topnav" role="navigation">
        <div class="container topnav">
            ...
            <div class="navbar-header">
				...
				<figure class="logo">
					<a class="navbar-brand topnav" href="/webcamservice"><span
						class="glyphicon glyphicon-camera"></span> - WebCamService</a>
				</figure>
			</div>
			...
			<div class="container">
				<div class="panel panel-default panel-login">
					<form action="efetuaLogin" method="post">
						...
						<div class="checkbox">
							<label> <a href="/webcamservice/novoUsuarioExterno">Cadastre-se</a></label> <label>
								<a href="/webcamservice/esqueceuSenha">Esqueceu a senha?</a>
							</label>
						</div>
